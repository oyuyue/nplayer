export const danmakuItems = [
  ...
  {
    text: '远东豹是不是都不到一百只啊？一只小宝宝的生死几乎承担了半个种群的存续 ',
    time: 130,
  },
  {
    text: 'slender 。。 ',
