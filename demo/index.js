...
const dan = new RPlayerDanmaku({
  ...
  items: [
    ...
    { text: '弹幕弹幕弹幕弹幕', time: 2 },
    { text: '弹幕弹幕', time: 2 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕asdsadasd幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕sad弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕12幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕wowowowo', time: 10, isMe: true },
    { text: '弹幕弹幕', time: 10 },
    { text: '弹幕弹弹幕弹幕幕', time: 10 },
    { text: '弹幕弹幕', time: 10 },
    { text: '弹幕弹幕弹幕弹幕', time: 10 },
  ]
})
